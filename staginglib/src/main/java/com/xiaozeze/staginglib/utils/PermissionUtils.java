...
import com.xiaozeze.staginglib.utils.constant.PermissionConstants;
import com.xiaozeze.staginglib.utils.PermissionUtils.OnRationaleListener.ShouldRequest;
...
import static com.xiaozeze.staginglib.utils.constant.PermissionConstants.Permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(XZUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(XZUtils.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + XZUtils.getApp().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(XZUtils.getApp());
    }
