...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) XZUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static boolean isLandscape() {
        return XZUtils.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) XZUtils.getApp().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                XZUtils.getApp().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (XZUtils.getApp().getResources().getConfiguration().screenLayout
    ...
    private static void adaptScreen(final Activity activity,
        ...
        final DisplayMetrics appDm = XZUtils.getApp().getResources().getDisplayMetrics();
        ...
        XZUtils.ADAPT_SCREEN_ARGS.sizeInPx = sizeInPx;
        XZUtils.ADAPT_SCREEN_ARGS.isVerticalSlide = isVerticalSlide;
    }
