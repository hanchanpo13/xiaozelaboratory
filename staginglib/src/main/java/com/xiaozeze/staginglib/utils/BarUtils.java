...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (XZUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, XZUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = XZUtils.getApp().getSystemService("statusbar");
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(XZUtils.getApp()).hasPermanentMenuKey();
