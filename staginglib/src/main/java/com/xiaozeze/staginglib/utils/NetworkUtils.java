...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) XZUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) XZUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) XZUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) XZUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
