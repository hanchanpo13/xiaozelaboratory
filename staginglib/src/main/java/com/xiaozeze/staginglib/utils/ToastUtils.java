...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = XZUtils.getApp().getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                if (XZUtils.isAdaptScreen()) {
                    XZUtils.cancelAdaptScreen();
                    sToast = ToastFactory.makeToast(XZUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = ToastFactory.newToast(XZUtils.getApp());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) XZUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification implements IToast {
        ...
        public void show() {
            ...
            mParams.packageName = XZUtils.getApp().getPackageName();
