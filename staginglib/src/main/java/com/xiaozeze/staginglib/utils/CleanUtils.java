...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(XZUtils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(XZUtils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(XZUtils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return XZUtils.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(XZUtils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(XZUtils.getApp().getExternalCacheDir());
    }
