...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final XZUtils.OnAppStatusChangedListener listener) {
        XZUtils.getActivityLifecycle().addListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        XZUtils.getActivityLifecycle().removeListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        XZUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        XZUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        return !isSpace(packageName)
                && XZUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName) != null;
    }
    ...
    public static boolean isAppInstalled(@NonNull final String action,
        ...
        PackageManager pm = XZUtils.getApp().getPackageManager();
    ...
    public static boolean isAppDebug() {
        return isAppDebug(XZUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(XZUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return XZUtils.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        XZUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = XZUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(XZUtils.getApp().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        XZUtils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(XZUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        XZUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = XZUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return XZUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(XZUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(XZUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(XZUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(XZUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(XZUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = XZUtils.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(XZUtils.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = XZUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) XZUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(XZUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) XZUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) XZUtils.getApp()
