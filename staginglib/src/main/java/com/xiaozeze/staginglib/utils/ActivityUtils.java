...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(XZUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(XZUtils.getApp().getPackageManager()) == null ||
                XZUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = XZUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(XZUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(XZUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(XZUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(XZUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Intent intent) {
        startActivity(intent, XZUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivity(@NonNull final Intent intent,
                                     @NonNull final Bundle options) {
        startActivity(intent, XZUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, XZUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, XZUtils.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return XZUtils.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(XZUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return XZUtils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = XZUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(XZUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(XZUtils.getApp(), clz));
    }
