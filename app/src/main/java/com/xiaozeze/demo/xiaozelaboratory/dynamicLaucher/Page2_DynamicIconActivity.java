package com.xiaozeze.demo.xiaozelaboratory.dynamicLaucher;
...
import com.xiaozeze.staginglib.utils.SPUtils;
import com.xiaozeze.staginglib.utils.AppUtils;
 ...
 * @Version: 1.0
 */
public class Page2_DynamicIconActivity extends Activity implements View.OnClickListener {
    ...
    public void checkAppIcon(Context ctx) {
        ...
        final String localIconKey = "DynamicIcon_" + AppUtils.getAppName();
        ...
        // 本地启动图类型
        String localLauncherType = SPUtils.getInstance("normal").getString(localIconKey, "");
        if (!serviceLauncherType.equals(localLauncherType)) {// 激活icon替换逻辑
            ...
            try {
                ...
                // 记录本次激活的入口
                SPUtils.getInstance("normal").put(localIconKey, serviceLauncherType);
            } catch (Exception e) {
                // 激活默认入口
                ...
                // 记录本次激活的入口
                SPUtils.getInstance("normal").remove(localIconKey);
            }
        }
    }
}
