...
//     * @param context          上下文
//     * @param content          文字内容
//     * @param lineHeight       行高（包含文字高度和行距）
//     * @param paragraphSpacing 请输入段落间距（单位dp）
//     * @param lineSpacingExtra 行间距
//     */
//    public static SpannableString getParagraphSpacingSpannable(Context context, String content, float lineHeight, int paragraphSpacing, float lineSpacingExtra) {
//        if (!content.contains("\n")) {
//            return null;
//        }
...
//        //int强转部分为：行高 - 行距 + 段距
//        d.setBounds(0, 0, 1, (int) ((lineHeight - lineSpacingExtra) / 1.2 + (paragraphSpacing * density - lineSpacingExtra)));
//
